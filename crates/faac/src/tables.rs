    ...
    vec![
        SrInfo {
            ...
            cb_width_long: {
                ...
                let d = [
                    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 8, 12, 12, 12, 12, 12,
                    16, 16, 24, 28, 36, 44, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64,
                ];
        ...
        SrInfo {
            ...
            cb_width_long: {
                let mut a = [0i32; NSFB_LONG];
                let d = [
                    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 12, 12, 12, 16, 16, 16,
                    20, 24, 24, 28, 36, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40,
                    40, 40, 40,
                ];
        ...
        SrInfo {
            ...
            cb_width_long: {
                let mut a = [0i32; NSFB_LONG];
                let d = [
                    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 8, 8, 8, 12, 12, 12, 12, 16, 16, 20,
                    20, 24, 24, 28, 28, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
                    32, 32, 32, 32, 96,
                ];
        ...
        SrInfo {
            ...
            cb_width_long: {
                let mut a = [0i32; NSFB_LONG];
                let d = [
                    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 12, 12, 12, 12,
                    16, 16, 16, 20, 20, 24, 24, 28, 28, 32, 36, 36, 40, 44, 48, 52, 52, 64, 64, 64,
                    64, 64,
                ];
                a[..47].copy_from_slice(&d);
                a
        ...
        SrInfo {
            ...
            cb_width_long: {
                ...
                let d = [
                    ...
                    16, 16, 20, 20, 20, 24, 24, 28, 28, 32, 36, 40, 40, 44, 48, 52, 56, 60, 64, 64,
                    64,
                ];
