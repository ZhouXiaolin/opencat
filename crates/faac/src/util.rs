...
pub fn get_sr_index(sample_rate: u32) -> usize {
    ...
    if sample_rate >= 75132 {
        return 1;
    }
    if sample_rate >= 55426 {
        return 2;
    }
    if sample_rate >= 46009 {
        return 3;
    }
    if sample_rate >= 37566 {
        return 4;
    }
    if sample_rate >= 27713 {
        return 5;
    }
    if sample_rate >= 23004 {
        return 6;
    }
    if sample_rate >= 18783 {
        return 7;
    }
    if sample_rate >= 13856 {
        return 8;
    }
    if sample_rate >= 11502 {
        return 9;
    }
    if sample_rate >= 9391 {
        return 10;
