...
pub struct ComputedVisualStyle {
    ...
    pub border_radius: crate::core::style::BorderRadius,
    pub border_width: Option<f32>,
    pub border_top_width: Option<f32>,
    pub border_right_width: Option<f32>,
    pub border_bottom_width: Option<f32>,
    pub border_left_width: Option<f32>,
    pub border_color: Option<crate::core::style::ColorToken>,
    pub stroke_color: Option<crate::core::style::ColorToken>,
    pub stroke_width: Option<f32>,
    pub stroke_dasharray: Option<f32>,
    pub stroke_dashoffset: Option<f32>,
    pub border_style: Option<crate::core::style::BorderStyle>,
