...
mod tests {
    ...
    use crate::core::style::{ColorToken, ObjectFit, TextAlign, Transform};
    ...
    fn script_driver_records_text_unit_override_via_part_set() {
        ...
        assert_eq!(
            o1.color,
            Some(crate::core::style::ColorToken::Custom(255, 255, 255, 255))
        );
    ...
    fn script_driver_split_text_color_animation_targets_parts() {
        ...
        assert_eq!(
            ...
            Some(crate::core::style::ColorToken::Custom(217, 70, 239, 255))
        );
        assert_eq!(
