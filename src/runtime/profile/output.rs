...
pub(crate) fn render_profile_text(summary: &RenderProfileSummary) -> String {
    ...
    out.push_str(&format!(
        ...
        average_usize(summary, |frame| frame.backend.text_cache_hits),
        average_usize(summary, |frame| frame.backend.text_cache_misses),
    ...
    out.push_str(&format!(
        ...
        average_usize(summary, |frame| frame.backend.text_cache_evictions),
        average_usize(summary, |frame| frame.backend.text_cache_record_repeats),
        average_usize(summary, |frame| frame.backend.text_cache_capacity_utilization),
